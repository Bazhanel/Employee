...
CREATE TABLE IF NOT EXISTS `employee_information` (
  ...
  `sport_category`          VARCHAR(50) NOT NULL, -- could be as INT with id value from additional table as "sport_category"
...
CREATE TABLE IF NOT EXISTS `user_roles` (
  `id`        INT         NOT NULL PRIMARY KEY, -- 1-admin, 2- employee, 3-client...
...
CREATE TABLE IF NOT EXISTS `locations` (
  `id`            INT         NOT NULL AUTO_INCREMENT PRIMARY KEY, -- 1 -Tychiny 
  `location_name` VARCHAR(50) NOT NULL,                            -- could be as INT with id value from additional table as "sport_category"
)
ENGINE = InnoDB;
