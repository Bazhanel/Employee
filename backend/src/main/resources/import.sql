INSERT INTO `organization` (`id`, `sname`, `name`, `phone`, `phone2`, `email`, `address`, `orgcode`) VALUES (1, 'Test Organization', 'Test Organization', NULL, NULL, 'org@org.com', 'Ukraine', '000000');
...
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (1, NULL, 'Energym 1', 'Energym 1', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (4, 1, 'Energym 1 1', 'Energym 1 1', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (5, 1, 'Energym 1 2', 'Energym 1 2', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (2, NULL, 'Energym 2', 'Energym 2', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (3, NULL, 'Energym 3', 'Energym 3', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (6, 3, 'Energym 3 1', 'Energym 3 1', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
INSERT INTO `department` (`id`, `pid`, `sname`, `name`, `datefrom`, `dateto`, `hier_level`, `organizationid`, `position`) VALUES (7, 3, 'Energym 3 2', 'Energym 3 2', CURRENT_TIMESTAMP, NULL, 1, 1, NULL);
...
INSERT INTO `gym` (`id`, `name`, `description`, `capacity`, `organization`) VALUES (1, 'Гимнастический зал', NULL, 20, 1);
